...
function Navbar({ onLogout }) {
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white px-3 rounded">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item me-2">
              <Link className="nav-link fw-bold" to="/places">Places</Link>
            </li>
            <li className="nav-item me-2">
              <Link className="nav-link fw-bold" to="/contact">Contact</Link>
            </li>
            <li className="nav-item me-2">
              <button onClick={onLogout} className="py-2 px-4 rounded-pill border-0 bg-dark text-white">Logout</button>
            </li>
          </ul>
        </div>
      </div>
